...
--init-hyperparams initial_epsilon:1.0 final_epsilon:0.05 epsilon_decay_steps:6000000 homotopy_decay_steps:8000000 "batch_size:128" "buffer_size:1000000" "net_arch:[256, 256, 256, 256]" \
