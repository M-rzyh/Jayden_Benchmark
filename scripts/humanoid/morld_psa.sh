...
--init-hyperparams shared_buffer:True exchange_every:20000 pop_size:6 "weight_adaptation_method:'PSA'" "policy_args:{'learning_starts':5000, 'batch_size':256, 'buffer_size':1000000, 'net_arch':[256,256,256,256]}"  \
--train-hyperparams eval_mo_freq:100000  \
--generalization-hyperparams num_eval_weights:100 num_eval_episodes:1 "algo_suffix:'_PSA'" record_video_w_freq:397 \
