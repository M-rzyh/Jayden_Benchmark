...
--init-hyperparams per:True gradient_updates:1 batch_size:256 learning_starts:25000 buffer_size:1000000 "net_arch:[256, 256, 256, 256]" dynamics_train_freq:4000 dynamics_rollout_freq:4000 dynamics_real_ratio:0.5 dynamics_min_uncertainty:10.0  \
