...
--init-hyperparams "policy_name:'MOSACDiscrete'" "shared_buffer:True" "exchange_every:20000" "pop_size:6" "policy_args:{'target_net_freq':2000, 'batch_size':128, 'buffer_size':1000000, 'net_arch':[256, 256, 256, 256], 'update_frequency': 1, 'target_entropy_scale':0.3}"  \
