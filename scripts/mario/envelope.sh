...
--init-hyperparams "net_arch:[512, 512]" batch_size:64 learning_starts:25000 num_sample_w:8 per:True initial_epsilon:0.2 final_epsilon:0.01 epsilon_decay_steps:1000000 homotopy_decay_steps:3000000 initial_homotopy_lambda:0.05 buffer_size:100000 gradient_updates:1 target_net_update_freq:1000 \
--train-hyperparams eval_mo_freq:100000 \
--generalization-hyperparams num_eval_weights:32 num_eval_episodes:1 record_video_w_freq:23 \
