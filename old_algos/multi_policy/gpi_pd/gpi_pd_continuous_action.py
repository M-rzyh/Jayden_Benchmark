...
from mo_utils.morl_algorithm import MORLAlgo
...
class GPIPDContinuousAction(MORLAlgo):
    """GPI-PD algorithm with continuous actions.
    ...
    def __init__(
        ...
        Args:
            ...
            num_eval_weights_for_front (int, optional): The number of weights to evaluate for the Pareto front. Defaults to 100.
            weight_selection_algo (str, optional): The weight selection algorithm to use. Defaults to "gpi-ls".
        ...
        """
        MORLAlgo.__init__(self, env, device=device, seed=seed)
        ...
        self.linear_support = LinearSupport(num_objectives=self.reward_dim, epsilon=0.0 if weight_selection_algo == "ols" else None)

        self.eval_weights = equally_spaced_weights(self.reward_dim, n=num_eval_weights_for_front)
    ...
    def train_iteration(
        ...
        # to check (how to include multiple environment steps per iteration)
