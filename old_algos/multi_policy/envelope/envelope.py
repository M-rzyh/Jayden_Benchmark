...
class Envelope(MORLAlgo):
    ...
    def __init__(
        ...
        Args:
            ...
            num_eval_weights_for_front: The number of weights to sample for creating the pareto front when evaluating.
        ...
        self.weights = th.tensor(w).float().to(self.device)
    ...
    @override
    def act(self, obs: th.Tensor, w: Optional[th.Tensor] = None) -> int:
        ...
        return self.max_action(obs, self.weights)
