...
class CAPQL(MORLAlgo):
    ...
    def __init__(
        ...
        self.weight_sampler = WeightSamplerAngle(self.env.unwrapped.reward_dim, angle)
    ...
    def update(self):
        ...
        if self.global_step < self.learning_starts: # need more samples in the buffer
            return
    ...
    def act(
        self, obs: Union[np.ndarray, th.Tensor], w: Union[np.ndarray, th.Tensor]
    ):
